...
f_write_a = open('%s/l%s/%s_xq%s%s_spec_m1_%s_m2_%s_%s.%sa'%(out_dir,ens_name,pre_name,xq,mom,mass1,mass2,sinks,i_file),'w')
f_write_b = open('%s/l%s/%s_xq%s%s_spec_m1_%s_m2_%s_%s.%sb'%(out_dir,ens_name,pre_name,xq,mom,mass1,mass2,sinks,i_file),'w')
