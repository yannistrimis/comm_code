0.1   THE MOST IMPORTAN THING IS NOT TO OVERWRITE THINGS IN THE OUTPUT DIRECTORY
...
0.2   ALSO IMPORTANT: RUN AND SUBMIT DIRECTORIES SHOULD BE UNIQUELY IDENTIFIED,
      SO THAT IN CASE MANY SCRIPTS (bzw FOR MANY MOMENTA) RUN SIMULTANEOUSLY, THERE IS
...
7. BUILD SCRIPT ndv3 MEASURES ALL, INCLUDING NON-LOCAL ONES.
8. forget_corr IN BUILD SCRIPTS LEADS TO CORRELATORS BEING ALL RECORDED IN
   SINGLE OUTPUT FILE
9. make_input_nd.sh WORKS BOTH FOR ndv3 AND nlv3 BUILD SCRIPTS.
