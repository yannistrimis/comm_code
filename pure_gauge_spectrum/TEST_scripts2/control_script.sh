...
do
	...
	bash ${path_build}/build_input.ks_spectrum_hisq.spectrum2v3.2.sh ${run_dir}/param_input > ${run_dir}/spec_input
	srun -n 16 ${path_build}/ks_spectrum_hisq_dbl_icc_20230125 ${run_dir}/spec_input > ${file_name}
