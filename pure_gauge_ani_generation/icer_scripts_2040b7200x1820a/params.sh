...
beta_s=3.95604 #in the MILC colde this appears first
beta_t=13.10400 #and this appears second
...
ensemble="2040b7200x1820a"
lat_name="l2040b7200x1820a"
out_name="out2040b7200x1820a"
...
run_dir="/mnt/scratch/trimisio/runs/rungenl2040b7200x1820a"
submit_dir="/mnt/home/trimisio/submits/subgenl2040b7200x1820a"
