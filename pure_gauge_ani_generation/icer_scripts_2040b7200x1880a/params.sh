...
beta_s=3.82979 #in the MILC colde this appears first
beta_t=13.53600 #and this appears second
...
ensemble="2040b7200x1880a"
lat_name="l2040b7200x1880a"
out_name="out2040b7200x1880a"
...
run_dir="/mnt/scratch/trimisio/runs/rungenl2040b7200x1880a"
submit_dir="/mnt/home/trimisio/submits/subgenl2040b7200x1880a"
