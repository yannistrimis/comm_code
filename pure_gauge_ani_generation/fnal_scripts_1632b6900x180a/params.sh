...
beta_s=3.83333333 #in the MILC colde this appears first
beta_t=12.42000000 #and this appears second
...
ensemble="1632b6900x180a"
lat_name="l1632b6900x180a"
out_name="out1632b6900x180a"
...
run_dir="/project/ahisq/yannis_puregauge/runs/rungenl1632b6900x180a"
submit_dir="/project/ahisq/yannis_puregauge/submits/subgenl1632b6900x180a"
