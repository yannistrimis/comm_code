...
beta_s=3.65979 #in the MILC colde this appears first
beta_t=13.77400 #and this appears second
...
ensemble="1632b7100x194a"
lat_name="l1632b7100x194a"
out_name="out1632b7100x194a"
...
run_dir="/project/ahisq/yannis_puregauge/runs/rungenl1632b7100x194a"
submit_dir="/project/ahisq/yannis_puregauge/submits/subgenl1632b7100x194a"
